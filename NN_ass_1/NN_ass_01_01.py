...
DATA_PATH = "/vol/home/s1594443/Desktop/Assignment_01/data/"
...
dim_1 = len ( train_in ) # 1707. Number of digits in training data.
dim_2 = len ( train_in[0] ) # 256. 256 dimensional space.
dim_3 = int ( len ( train_in[0] ) ** 0.5 ) # 16. Length and width of an image.
dim_4 = len ( test_in ) # 1000. Number of digits in testing data.
dim_5 = 10 # Number of possible digits.
